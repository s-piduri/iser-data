...
load("../rdata/is_standards.RData")
load("../rdata/entable.RData")
load("../rdata/jobs.RData")
load("../rdata/demo.RData")
load("../rdata/labor_data.RData")
...
annual_hc %>% 
  ...
  flextable() %>% 
  set_caption("Unduplicated Annual Headcount, All Students", 
...
annual_c_hc %>% 
  #pivot_wider(names_from="Academic Year", values_from = "Headcount") %>% 
  flextable() %>% 
  set_caption("Unduplicated Annual Credit Headcount", 
              autonum = run_autonum(seq_id='tab', bkm='chc')) %>% 
  footnote(j=1, value=as_paragraph("Source: CCC Chancellor's Office Data Mart"),
           ref_symbols=c(""), part = "header") %>% 
  width(width=3.2)
...
annual_nc_hc %>% 
  #pivot_wider(names_from="Academic Year", values_from = "Headcount") %>% 
  flextable() %>% 
  set_caption("Unduplicated Annual Non-Credit Headcount", 
              autonum = run_autonum(seq_id='tab', bkm='nchc')) %>% 
  footnote(j=1, value=as_paragraph("Source: CCC Chancellor's Office Data Mart"),
           ref_symbols=c(""), part = "header") %>% 
  width(width=3.2)
```
...
annual_sc %>% 
  #pivot_wider(names_from="Academic Year", values_from = "Headcount") %>% 
  flextable() %>% 
  set_caption("Annual Seatcount, All Students", 
              autonum = run_autonum(seq_id='tab', bkm='sc')) %>% 
  footnote(j=1, value=as_paragraph("Source: CCC Chancellor's Office Data Mart"),
           ref_symbols=c(""), part = "header") %>% 
  width(width=3.2)
...
annual_c_sc %>% 
  #pivot_wider(names_from="Academic Year", values_from = "Headcount") %>% 
  flextable() %>% 
  set_caption("Annual Credit Seatcount", 
              autonum = run_autonum(seq_id='tab', bkm='csc')) %>% 
  footnote(j=1, value=as_paragraph("Source: CCC Chancellor's Office Data Mart"),
           ref_symbols=c(""), part = "header") %>% 
  width(width=3.2)
...
annual_nc_sc %>% 
  #pivot_wider(names_from="Academic Year", values_from = "Headcount") %>% 
  flextable() %>% 
  set_caption("Annual Noncredit Seatcount", 
              autonum = run_autonum(seq_id='tab', bkm='ncsc')) %>% 
  footnote(j=1, value=as_paragraph("Source: CCC Chancellor's Office Data Mart"),
           ref_symbols=c(""), part = "header") %>% 
  width(width=3.2)
...
```{r, ft.align='left'}
##code block for ftes overall annual
```
